 ...
 * 
 * <p>
 * This class tracks fields line-by-line. A field with multiple comma- separated
 * values on the same line will be treated as a field with a single value by
 * this class. It is the caller's responsibility to detect and split on commas
 * if their field permits multiple values. This simplifies use of single-valued
 * fields whose values routinely contain commas, such as cookies or dates.
 * 
 * <p>
...
final class RawHeaders {
	...
	public void add(String fieldName, String value) {
		...
		if (value == null) {
			 ...
			 */
			System.err.println("Ignoring HTTP header field '" + fieldName
	...
	/**
	 * @param fieldNames
	 *            a case-insensitive set of HTTP header field names.
	 */
	...
	public Map<String, List<String>> toMultimap() {
		...
		if (statusLine != null) {
			result.put(null, Collections.unmodifiableList(Collections
					.singletonList(statusLine)));
		}
