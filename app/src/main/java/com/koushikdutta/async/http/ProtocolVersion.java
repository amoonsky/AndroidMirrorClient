...
public class ProtocolVersion implements Serializable, Cloneable {
	 ...
	 * classes to instantiate themselves instead of the base class, and to
	 * define constants for commonly used versions. <br/>
	...
	/**
	 * Checks equality of this protocol version with an object. The object is
	 * equal if it is a protocl version with the same protocol name, major
	 * version number, and minor version number. The specific class of the
	 * object is <i>not</i> relevant, instances of derived classes with
	 * identical attributes are equal to instances of the base class and vice
	 * versa.
	 * 
	 * @param obj
	...
	/**
	 * Checks whether this protocol can be compared to another one. Only
	 * protocol versions with the same protocol name can be
	...
	/**
	 * Compares this protocol version with another one. Only protocol versions
	 * with the same protocol name can be compared. This method does <i>not</i>
	 * define a total ordering, as it would be required for {@link Comparable}.
	 * 
	 * @param that
	 *            the protocl version to compare with
	 * 
	 * @return a negative integer, zero, or a positive integer as this version
	 *         is less than, equal to, or greater than the argument version.
	 * 
	 * @throws IllegalArgumentException
	 *             if the argument has a different protocol name than this
	 ...
	 *         {@link #isComparable comparable} to the argument and
	 *         {@link #compareToVersion compares} as greater or equal,
	 *         <code>false</code> otherwise
	 */
	 ...
	 * @return <code>true</code> if this protocol version is
	 *         {@link #isComparable comparable} to the argument and
	 *         {@link #compareToVersion compares} as less or equal,
	 *         <code>false</code> otherwise
	 */
