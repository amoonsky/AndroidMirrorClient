 ...
 * {@linkplain java.net.URI#getScheme() scheme} (http, https, etc.) of the URL,
 * not the protocol (http/1.1, spdy/3.1, etc.). OkHttp uses the word
...
public enum Protocol {
	 ...
	 * "http://dev.chromium.org/spdy/spdy-protocol/spdy-protocol-draft3-1">draft
	 * 3.1</a>. Future releases of OkHttp may use this identifier for a newer
	 * draft of the SPDY spec.
	 */
	SPDY_3("spdy/3.1") {
		@Override
	 ...
	 * <p/>
	 * <p>
	 * This version of OkHttp implements HTTP/2 <a
	 * href="http://tools.ietf.org/html/draft-ietf-httpbis-http2-13">draft
	 * 12</a> with HPACK <a href=
	 * "http://tools.ietf.org/html/draft-ietf-httpbis-header-compression-08"
	 * >draft 6</a>. Future releases of OkHttp may use this identifier for a
	 * newer draft of these specs.
	 */
	HTTP_2("h2-13") {
		@Override
		public boolean needsSpdyConnection() {
