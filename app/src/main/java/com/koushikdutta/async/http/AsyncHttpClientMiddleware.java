...
/**
 * AsyncHttpClientMiddleware is used by AsyncHttpClient to inspect, manipulate,
...
public interface AsyncHttpClientMiddleware {
	...
	public static class OnHeadersReceivedDataOnRequestSentData extends
			OnRequestSentData {
	}

	public static class OnBodyDataOnRequestSentData extends
			OnHeadersReceivedDataOnRequestSentData {
		public DataEmitter bodyEmitter;
	}

	public static class OnResponseCompleteDataOnRequestSentData extends
			OnBodyDataOnRequestSentData {
	...
	/**
	 * Called once the headers and any optional request body has been sent
	 * 
	 * @param data
	 */
	...
	/**
	 * Called once the request is complete and response has been received, or if
	 * an error occurred
	 * 
	 * @param data
	 */
