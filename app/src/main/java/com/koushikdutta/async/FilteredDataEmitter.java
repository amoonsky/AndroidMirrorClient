...
public class FilteredDataEmitter extends DataEmitterBase implements
		DataEmitter, DataCallback, DataEmitterWrapper, DataTrackingEmitter {
	...
	public void onDataAvailable(DataEmitter emitter, ByteBufferList bb) {
		if (closed) {
			// this emitter was closed but for some reason data is still being
			// spewed...
			// eat it, nom nom.
			bb.recycle();
			return;
		...
		// if there's data after the emitting, and it is paused... the
